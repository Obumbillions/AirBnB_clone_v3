...
class TestCityDocs(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.city_f   def test_pep8_conformance_city(self):
        ""= inspect.getmembers(City, inspect.isfunction)

  "Test that models/city.py conforms to PEP8."""
   esult = pep8s.check_files(['models/city.py'])
         pep8s = pep8.StyleGuide(quiet=True)
        r    self.assertEqual(result.total_errors, 0,
